...
os.environ["WANDB_API_KEY"] = 'd45d05251194d021a62b5352f3be2e4dc07138d5'
...
class SegmentationTrainer(v8.detect.DetectionTrainer):
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        cfg = '/traindata/zhaoying/yolov8_x_lung/yolov8_x_thyroid/ultralytics/ultralytics/models/v8/yolov8-seg.yaml'
...
def train(cfg=DEFAULT_CFG, use_python=False):
    ...
    model = ' ' # chekpoint path
    data = '.yaml'  # train data path
